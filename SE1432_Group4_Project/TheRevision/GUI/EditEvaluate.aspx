<%@ Page Title="" Language="C#" MasterPageFile="~/Skeleton.Master" AutoEventWireup="true" CodeBehind="EditEvaluate.aspx.cs" Inherits="TheRevision.GUI.EditEvaluate" %>
    ...
    <div class="left">
        ...
        <table style="width:100%;">
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <input type="range" min="0" max="10" value="<%= vote %>" class="slider" id="scoreRange" step="1" onchange="displayScore(this.value)">
